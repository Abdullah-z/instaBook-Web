...
export const themes = {
  ...
  neonPink: {
    ...
    bgPrimary: "rgb(246, 246, 246)",
    bgSurface: "rgb(255, 255, 255)",
    textPrimary: "rgb(30, 26, 28)",
    textSecondary: "rgb(80, 67, 73)",
    dark: {
      primary: "rgb(255, 105, 180)",
      bgPrimary: "rgb(20, 15, 18)",
      bgSurface: "rgb(30, 20, 25)",
      textPrimary: "rgb(255, 230, 240)",
      textSecondary: "rgb(230, 190, 210)",
    },
  },
  neonCyan: {
    ...
    bgPrimary: "rgb(246, 246, 246)",
    bgSurface: "rgb(255, 255, 255)",
    textPrimary: "rgb(24, 30, 30)",
    textSecondary: "rgb(60, 75, 75)",
    dark: {
      primary: "rgb(0, 255, 255)",
      bgPrimary: "rgb(10, 20, 20)",
      bgSurface: "rgb(15, 30, 30)",
      textPrimary: "rgb(220, 255, 255)",
      textSecondary: "rgb(180, 220, 220)",
    },
  },
  neonLime: {
    ...
    bgPrimary: "rgb(246, 246, 246)",
    bgSurface: "rgb(255, 255, 255)",
    textPrimary: "rgb(28, 30, 24)",
    textSecondary: "rgb(70, 75, 60)",
    dark: {
      primary: "rgb(204, 255, 0)",
      bgPrimary: "rgb(18, 20, 15)",
      bgSurface: "rgb(25, 30, 20)",
      textPrimary: "rgb(240, 255, 220)",
      textSecondary: "rgb(200, 220, 180)",
    },
  },
  electricBlue: {
    ...
    bgPrimary: "rgb(246, 246, 246)",
    bgSurface: "rgb(255, 255, 255)",
    textPrimary: "rgb(24, 28, 30)",
    textSecondary: "rgb(60, 70, 75)",
    dark: {
      primary: "rgb(125, 249, 255)",
      bgPrimary: "rgb(10, 18, 20)",
      bgSurface: "rgb(15, 25, 30)",
      textPrimary: "rgb(220, 245, 255)",
